package it.piergiuseppe82.neo4jspring.applications;

import it.piergiuseppe82.neo4jspring.entity.Person;
import it.piergiuseppe82.neo4jspring.entity.Post;
import it.piergiuseppe82.neo4jspring.entityrepository.PersonRepository;
import it.piergiuseppe82.neo4jspring.entityrepository.PostRepository;
import it.piergiuseppe82.neo4jspring.supports.Utility;
...
public class Application implements CommandLineRunner {
	...
	@Configuration
	@EnableNeo4jRepositories(basePackages = "it.piergiuseppe82.neo4jspring")
	static class ApplicationConfig extends Neo4jConfiguration {

		public ApplicationConfig() {
			setBasePackage("it.piergiuseppe82.neo4jspring");
		}
